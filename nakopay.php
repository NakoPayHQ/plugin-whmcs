...
function nakopay_config()
{
    ...
    return [
        ...
        'ApiBaseUrl' => [
            'FriendlyName' => 'API Base URL override (advanced)',
            'Type'         => 'text',
            'Size'         => '60',
            'Default'      => '',
            'Description'  => 'Blank = default (<code>' . htmlspecialchars(Client::BASE_PRIMARY) . '</code>). Leave blank unless instructed by NakoPay support or you are pointing at a self-hosted base.',
        ],
    ];
}
